...
public:
  ...
  inline uint16_t get_ecd(uint8_t motor_id) const { return motor_measure_[motor_id].ecd; }
  inline int16_t get_speed(uint8_t motor_id) const { return motor_measure_[motor_id].speed_rpm; }
};
